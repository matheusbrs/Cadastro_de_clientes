...
<body>
    <form class="form_cadastro" action="" method="POST">
        ...
        <div class="ctr1">
            <div>
                <input type="text" name="nome" placeholder="Nome" value="<?php echo $cliente['nome']; ?>">

                <input type="email" name="email" placeholder="E-mail" value="<?php echo $cliente['email']; ?>">
            </div>
            <div class="">
                <input type="text" name="telefone" placeholder="telefone" value="<?php if (!empty($cliente['telefone'])) {
                                                                                        echo formata_telefone($cliente['telefone']);
                                                                                    } ?>">
                <input type="password" name="senha" placeholder="Senha" value="<?php echo $cliente['senha']; ?>">
            </div>
            <div class="">
                <input type="text" name="endereco" placeholder="Endereço" value="<?php echo $cliente['endereco']; ?>">
                <input type="text" name="cpf" placeholder="cpf" value="<?php echo $cliente['cpf']; ?>">
            </div>
            <div>
                <input class="inp_nascimento" name="nascimento" type="text" placeholder="Nascimento" value="<?php if (!empty($cliente['nascimento'])) {
                                                                                                                echo formatar_data($cliente['nascimento']);
                                                                                                            } ?>">
            </div>

            <input class="bnt_cadastro" type="submit" value="Salvar Cliente">
            <a href="lista.php">Voltar para lista de clientes </a>
        </div>
